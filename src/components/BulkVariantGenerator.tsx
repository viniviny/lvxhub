...
export function BulkVariantGenerator({
  ...
  const handleGenerate = useCallback(async () => {
    ...
    // Universal premium prompt enhancement (centralized)
    const PREMIUM_STYLE = enhancePremiumPrompt('Color variant generation — preserve product silhouette, change only the color while keeping all premium photography standards.');
